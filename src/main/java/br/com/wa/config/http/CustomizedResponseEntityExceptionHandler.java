...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<br.com.wa.http.domain.response.DefaultResponse> handleValidationExceptions(ValidationException ex, WebRequest request) {
        Optional<ResponseStatus> annotationResponse = getResponseAnnotation(ex.getClass());
        return baseHandler(ex, annotationResponse, BAD_REQUEST);
    }
